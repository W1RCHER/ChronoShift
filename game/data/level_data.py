...
LEVELS: list[LevelDefinition] = [
    LevelDefinition(
        ...
        exit_y=520,
        platforms=[
            RectBlock(1200, 60, 2400, 40, PLATFORM_COLOR),
            ...
            RectBlock(1880, 270, 220, 24, PLATFORM_COLOR),
            RectBlock(2200, 450, 220, 24, PLATFORM_COLOR),
        ],
        enemies=[
            EnemySpawn(540, 110, 300, 820, 2.0),
            EnemySpawn(1500, 110, 1320, 1760, 2.2),
            EnemySpawn(2040, 110, 1880, 2250, 2.4),
        ],
        cores=[
            CoreSpawn(350, 230),
            CoreSpawn(640, 320),
    ...
    LevelDefinition(
        ...
        platforms=[
            ...
            RectBlock(340, 220, 200, 24, PLATFORM_COLOR),
            RectBlock(640, 220, 200, 24, PLATFORM_COLOR),
            RectBlock(940, 320, 220, 24, PLATFORM_COLOR),
            RectBlock(1250, 420, 220, 24, PLATFORM_COLOR),
            RectBlock(1580, 320, 220, 24, PLATFORM_COLOR),
            RectBlock(1910, 220, 220, 24, PLATFORM_COLOR),
            RectBlock(2240, 320, 220, 24, PLATFORM_COLOR),
            RectBlock(2570, 420, 220, 24, PLATFORM_COLOR),
            RectBlock(2920, 450, 220, 24, PLATFORM_COLOR),
        ],
        enemies=[
            EnemySpawn(760, 110, 420, 1080, 2.5),
            EnemySpawn(1710, 110, 1450, 1980, 2.7),
            EnemySpawn(2710, 110, 2400, 3020, 3.0),
        ],
        cores=[
            CoreSpawn(340, 270),
            CoreSpawn(940, 370),
